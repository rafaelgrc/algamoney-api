...
public class LancamentoResource {
	...
	public ResponseEntity<Lancamento> buscarPeloCodigo(@PathVariable Long codigo) {
		...
		return lancamentoSalvo != null ? ResponseEntity.ok().body(lancamentoSalvo) : ResponseEntity.notFound().build();
	}
	...
	//feita aqui porque no exceptionHandler são as excessoes genericas e aqui é especifica para esse caso
